...
static public class NGUIText
{
	...
	/// <summary>
	/// Single the width of the specified glyph. Returns zero if the glyph could not be retrieved.
	/// </summary>
	...
	/// <summary>
	/// Single the index of the closest character within the provided list of values.
	...
	/// <summary>
	/// Single the printed size of the specified string. The returned value is in pixels.
	/// </summary>
	...
	/// <summary>
	/// Single the end of line that would fit into a field of given width.
	/// </summary>
