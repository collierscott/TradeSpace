...
public abstract class UIRect : MonoBehaviour
{
	...
	/// <summary>
	/// Single the rectangle's parent, if any.
	/// </summary>
	...
	/// <summary>
	/// Single the final cumulative alpha.
	/// </summary>
	...
	/// <summary>
	/// Single the sides of the rectangle relative to the specified transform.
