...
static public class NGUITools
{
	...
	/// <summary>
	/// Single the rootmost object of the specified game object.
	/// </summary>
	...
	/// <summary>
	/// Single sides relative to the specified camera. The order is left, top, right, bottom.
	/// </summary>
	...
	/// <summary>
	/// Single the camera's world-space corners. The order is bottom-left, top-left, top-right, bottom-right.
	/// </summary>
